...
MapForm2::OnInitializing(void)
{
	...
	// TODO: Add your initialization code here
	 ...
	 //__pTab->SetSelectedItem(__pTab->GetItemIndexFromActionId(id));
	//TODO//__pTab->AddActionEventListener(*this);
...
void
MapForm2::OnActionPerformed(const Osp::Ui::Control& source, int actionId)
{
	result r = E_SUCCESS;
	switch(actionId)
	{
